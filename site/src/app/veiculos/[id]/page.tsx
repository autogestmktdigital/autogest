...
export default function VehicleDetailPage() {
  ...
  const whatsappMessage = encodeURIComponent(`Olá! Vi no site o ${vehicle.brand} ${vehicle.model}${vehicle.version ? ` ${vehicle.version}` : ''} ${formatVehicleYear(vehicle)} por ${formatCurrency(vehicle.price)} e gostaria de mais informações.`);
